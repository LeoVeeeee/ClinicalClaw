"""Hybrid retrieval by combining sparse and mock dense scores."""
...
class HybridRetriever:
    ...
    def __init__(
        ...
        self.dense = MockDenseRetriever(documents)
    ...
    def search(self, query: str, top_k: int = 5) -> list[RetrievalResult]:
        ...
        dense_scores = {result.document.doc_id: result.score for result in dense_results}
